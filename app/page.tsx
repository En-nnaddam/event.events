        ...
        <div className="mx-auto grid min-h-[72svh] max-w-6xl content-center gap-10 px-5 py-8 sm:px-6 lg:grid-cols-[1fr_360px] lg:px-8">
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              ...
              <Link
                href="/auth"
                className="inline-flex h-10 items-center justify-center rounded-md border border-border bg-background/70 px-4 text-sm font-medium text-foreground transition hover:bg-background focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-ring/40"
              >
                Sign in
              </Link>
            </div>
